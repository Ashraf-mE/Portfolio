    ...
    <section id='skills'>
        ...
        <div className="skillBars">
            <div className="skillBar">
                <img src="assets/ui-design.png" alt="img" className="skillBarImg" />
            ...
            <div className="skillBar">
                <img src="assets/website-design.png" alt="img" className="skillBarImg" />
                <div className="skillBarText">
            ...
            <div className="skillBar">
                <img src="assets/app-design.png" alt="img" className="skillBarImg" />
                <div className="skillBarText">
                    <h2>Databases</h2>
                    <p>Sample text.....</p>
                </div>
